...
export const HttpRequestDialog = ({open,onOpenChange,onSubmit,defaultBody="",defaultMethod="GET",defaultEndpoint=""}:HttpRequestDialogProps)=>{
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Configure settings for Http trigger node</DialogDescription>
                </DialogHeader>
                <Form {...form}>
                        ...
                        <FormField 
                            ...
                            render ={({field})=>(
                                <FormItem>
                                    ...
                                    <FormDescription>The HTTP method used for this request</FormDescription>
                                    <FormMessage/>
                                </FormItem>
                            )}
                            />
